...
namespace MsOSProgram.core.Algorithm
{
    ...
    class FCFS
    {
        ...
        public Process run()
        {
            ...
            //Console.WriteLine("===========================");
            //Console.WriteLine("Current Working Process : " + process.processId.ToString());
            //Console.WriteLine("Arrive Time : " + process.arrTime.ToString());
            //Console.WriteLine("Burst Time : " + process.burstTime.ToString());
